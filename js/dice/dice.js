// d20 roll: button animation, roll result, flavor text, and the page's
// temporary background tint based on the roll -- purely cosmetic, no
// game mechanics attached to it.
